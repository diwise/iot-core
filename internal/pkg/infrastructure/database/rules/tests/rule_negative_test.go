...
func Test_That_Rule_For_V_Without_MinMax_Fails(t *testing.T) {
	...
	is.NoErr(err) // // should return error for V rule with nil min/max
}
...
func Test_That_Rule_For_Vs_Without_Value_Fails(t *testing.T) {
	...
	is.NoErr(err) // should return error for VS rule with nil value
}
...
func Test_That_Rule_For_Vb_Without_Value_Fails(t *testing.T) {
	...
	is.NoErr(err) // should return error for VB rule with nil value
}
