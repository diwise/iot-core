...
func TestLevel(t *testing.T) {
	...
	lvl.Handle(context.Background(), newDistance(1.27), func(string, float64, time.Time) {})
...
func TestLevelWithOverflowCapsPctTo100(t *testing.T) {
	...
	lvl.Handle(context.Background(), newDistance(0.5), func(string, float64, time.Time) {})
