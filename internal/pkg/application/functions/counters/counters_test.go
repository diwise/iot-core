...
func TestCounter(t *testing.T) {
	...
	c := New()
	c.Handle(context.Background(), newState(true), false, func(string, float64, time.Time) error { return nil })
...
func TestCounterOnOffOn(t *testing.T) {
	...
	c := New()
	c.Handle(context.Background(), newState(true), false, func(string, float64, time.Time) error { return nil })
	c.Handle(context.Background(), newState(false), false, func(string, float64, time.Time) error { return nil })
	c.Handle(context.Background(), newState(true), false, func(string, float64, time.Time) error { return nil })
	c.Handle(context.Background(), newState(false), false, func(string, float64, time.Time) error { return nil })
