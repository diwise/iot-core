...
import (
	...
	"github.com/diwise/iot-core/internal/application/functions/airquality"
	"github.com/diwise/iot-core/internal/application/functions/buildings"
	"github.com/diwise/iot-core/internal/application/functions/counters"
	"github.com/diwise/iot-core/internal/application/functions/digitalinput"
	"github.com/diwise/iot-core/internal/application/functions/levels"
	"github.com/diwise/iot-core/internal/application/functions/presences"
...
func (f *fnct) Handle(ctx context.Context, e *events.MessageAccepted, msgctx messaging.MsgContext) error {
	...
	if changed || f.OnUpdate {
		...
		log.Debug("publishing message",
			...
			slog.String("content_type", fumsg.ContentType()),
